...
class AppDB {
  ...
  String get apiKey => getValue("apiKey", defaultValue: "HBJ6NMkdroufMP8cr4LDB5mAFzn5PFmVLpb/jDnwZhs=");

  set apiKey(String update) => setValue("apiKey", update);

  String get appLanguage => getValue("app_language",defaultValue: "V7uNYL1Us2U4QcnDZWPRJA==") ;
