...
class _AuthApi implements AuthApi {
  ...
  Future<BaseResponse<HomeRequestModel>> home(Map<String, dynamic> data) async {
    ...
    _data.addAll(data);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<HomeRequestModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BaseResponse<HomeRequestModel>.fromJson(
      _result.data!,
      (json) => HomeRequestModel.fromJson(json as Map<String, dynamic>),
    );
    return value;
  }

  @override
  Future<CategoryResponse> categories(Map<String, dynamic> data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
