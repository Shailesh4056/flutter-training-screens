...
var data =  authStore.homeData!.data!;
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
         data.name.toString(),
          style: textBold.copyWith(fontSize: 20.spMin, color: AppColor.green),
        ),
        elevation: 0,
        backgroundColor: AppColor.white,
        actions: [
          ...
          CircleAvatar(
            radius: 14.r,
            backgroundImage: CachedNetworkImageProvider(data.profileImage.toString()),
          ),
          20.horizontalSpace,
        ],
      ),
                                ...
                                Container(
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      backgroundImage: CachedNetworkImageProvider(
                                          data.celebrity![index].profileImage.toString()),
                                    )),
                                15.verticalSpace,
                                Text(
                    ...
                    child: Column(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                               data.normalCampaignData!.campaignMediaList![0].image.toString(),
                            height: 175.h,
                            fit: BoxFit.contain,
                            placeholder: (context, url) =>
                                Center(child: new CircularProgressIndicator()),
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              data.normalCampaignData!.campaignName.toString(),
                              style: textBold.copyWith(
                                fontSize: 14.sp,
                              ),
                            ),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  RichText(
                                    text: TextSpan(
                                      text: "${data.normalCampaignData!.totalBudget} raised ",
                                      style: textRegular.copyWith(
                                          color: AppColor.green,
                                          fontSize: 12.sp),
                                      children: <InlineSpan>[
                                        TextSpan(
                                          text: "(${data.normalCampaignData!.donatedAmount}  goal)",
                                          style: textRegular.copyWith(
                                              color: AppColor.grey,
                                              fontSize: 12.sp),
                                          recognizer: TapGestureRecognizer()
