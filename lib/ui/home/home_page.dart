...
enum FilesType { image, video, documents, audio }
       ...
       // SizedBox(height: 30.h), // Adjust as needed for spacing
          // Text(
          //   S.current.mobileNo,
          ...
          //             style: textMedium.copyWith(fontSize: 15.spMin),
          //           ),
          //           SizedBox(width: 5.w),
          //           Image.asset(
          ...
          // Text(
          //   S.current.byContinuingYouAreAgreeingToOutTermsConditionsPrivacy,
