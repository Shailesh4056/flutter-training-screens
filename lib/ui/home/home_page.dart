...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Future<void> getHomeData() async {
    await authStore.home({"social_profile_id": "214"});
  }
  ...
  Widget build(BuildContext context) {
    return Observer(builder: (context) {
      ...
      return authStore.homeData?.data != null
          ? Scaffold(
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: data.idImage.toString(),
                                    height: 60.h,
                                    width: 60,
                                    fit: BoxFit.contain,
                                    placeholder: (context, url) => Center(
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Image(
                                        image:
                                            AssetImage(Assets.imageCommitted))
                                  ],
                                ),
                              ),
                              Container(
                                ...
                                onTap: () {
                                  showModalBottomSheet(
                                    ...
                                    builder: (context) {
                                      ...
                                      ListTile infoGet(String name, String info, String image) {
                                        return ListTile(
                                          leading: Image.asset(image, height: 50.h),
                                          title: Text(
                                            name,
                                            style: TextStyle(
                                                fontFamily: 'fraunces',
                                      ...
                                      var insta = data.instagramUrl;
                                      var linkdin = data.linkedinUrl;

                                      return Wrap(
                                        children: [
                                          Column(children: [
                                            infoGet(
                                                email!, 'email', Assets.imagePhone),
                                            infoGet(contact!, 'contact',
                                                Assets.imageEmail),
                                            infoGet(whatsApp!, 'WhatsApp',
                                                Assets.imageWhatsapp),
                                            infoGet(
                                                insta!, 'insta', Assets.imageWhatsapp),
                                            infoGet(linkdin!, 'Linkedin',
                                                Assets.imageWhatsapp),
                                          ]),
                                        ],
                                      );
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration:
                                BoxDecoration(color: AppColor.grayLight),
                            width: 1.sw,
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: data.normalCampaignData!
                                        .campaignMediaList![0].image
                                        .toString(),
                                    height: 175.h,
                                    fit: BoxFit.contain,
                                    placeholder: (context, url) => Center(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            "End  Date ; ${data.normalCampaignData!.endDate.toString()}",
                                            style: textRegular.copyWith(
                                              fontSize: 12.sp,
                                              fontWeight: FontWeight.w700,
                                              color: AppColor.burntOrange,
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            "${data.normalCampaignData!.totalParticipated.toString()}participated",
                                            style: textRegular.copyWith(
                                              fontSize: 12.sp,
                                              fontWeight: FontWeight.w700,
                                              color: AppColor.burntOrange,
                                ...
                                15.verticalSpace,
                                Text(
                                  data.normalCampaignData!.discription
                                      .toString(),
                                  style: textRegular.copyWith(
                                      fontSize: 12.sp,
                                      fontWeight: FontWeight.w400),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          RichText(
                                            text: TextSpan(
                                              text:
                                                  "${data.normalCampaignData!.totalBudget} raised ",
                                              style: textRegular.copyWith(
                                                  color: AppColor.green,
                                                  fontSize: 12.sp),
                                              children: <InlineSpan>[
                                                TextSpan(
                                                  text:
                                                      "(${data.normalCampaignData!.donatedAmount}  goal)",
                                                  style: textRegular.copyWith(
                                                      color: AppColor.grey,
                                                      fontSize: 12.sp),
                                                  recognizer:
