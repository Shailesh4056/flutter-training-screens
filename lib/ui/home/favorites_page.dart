            ...
            children: [
              AppImage(
               ...
               height: 139.h,
                width: 169.w,
                radius: 5.r,
                placeHolder: buildShimmerEffect(radius: 5.r, width: 134.w, height: 169.h),
              ),
                ...
                Positioned(
                  ...
                  left: 0,
                  child: Visibility(
                    visible: index%2==0?true:false, // Set this to false to hide the container
                    child: Container(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      " | 256",
                      style: textRegular.copyWith(color: AppColor.grey, fontSize: 12.spMin),
                    ),
                  ],
                ),
                SizedBox(height: 8.h),
      ...
      child: Column(
        ...
        children: [
          AppImage(
            ...
            placeHolder: buildShimmerEffect(radius: 5.r,  height: 159.h, width: 1.sw),
          ),
          ...
          Row(
            ...
            children: [
              Column(
                ...
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Text("${favoritesStorePageImages[index]['title']}",style:textRegular.copyWith(fontSize: 16.sp),).wrapPaddingOnly(top: 5, bottom: 10),
                  Text("3038 Godfrey Stree Tigard, OR 97223",style: textRegular.copyWith(fontSize: 12.sp),),
                ],
              ),
