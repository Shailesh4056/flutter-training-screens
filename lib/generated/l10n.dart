...
class S {
  ...
  String get impactingLivesOneNotificationsAtATime {
    return Intl.message(
      'Impacting lives one notifications at a time',
      name: 'impactingLivesOneNotificationsAtATime',
      desc: '',
      args: [],
    );
  }
  ...
  /// `| #nayadeshnayisoch`
  String get nayadeshnayisoch {
    return Intl.message(
      '| #nayadeshnayisoch',
      name: 'nayadeshnayisoch',
      desc: '',
      args: [],
    );
  }
  ...
  /// `By continuing, you are agreeing to out terms & conditions & privacy policy`
  String get byContinuingYouAreAgreeingToOutTermsConditionsPrivacy {
    return Intl.message(
      'By continuing, you are agreeing to out terms & conditions & privacy policy',
      name: 'byContinuingYouAreAgreeingToOutTermsConditionsPrivacy',
      desc: '',
      args: [],
    );
  }
